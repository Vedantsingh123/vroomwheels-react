...
const SignUp = () => {
  return (
    ...
    px-12 py-8 flex items-center justify-center'>
      <div className='bg-zinc-800 rounded-lg px-8 py-5 w-full md:w-3/6 lg:w-2/6 mt-[60px]'>
      ...
      <div className='mt-4'>
       <button className='w-full bg-red-500 text-white font-semibold py-2 rounded hover:bg-white hover:text-zinc-900 transition-all duration-300'>SignUp</button>
       <div> 
        <p className='flex mt-4 items-center justify-center text-zinc-200 font-semibold'>Or</p>
        <p className='flex mt-4 items-center justify-center text-zinc-500 font-semibold'>Already have an account? &nbsp; <Link to='/sign-in' className='hover:text-blue-500'><p>LogIn</p></Link></p>
       </div>
      </div>
      </div>
      </div>
